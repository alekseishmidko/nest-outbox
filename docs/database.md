...
Хранит состояние Process Manager для длительного workflow после создания заказа:
стадии avatar/QR, завершенные шаги, ошибку и возможность resume после retry.
